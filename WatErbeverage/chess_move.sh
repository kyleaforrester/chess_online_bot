...
do
  ...
  fen=`echo $query_response | grep -Eo "\"id\":[0-9]*,\"fen\":\"[a-zA-Z0-9\/]* [wb]* [abcdefghABCDEFGHkqKQ\-]* [a-z0-9\-]* [0-9]* [0-9]*" | sort | uniq | grep $x | grep -Eo "[a-zA-Z0-9\/]* [wb]* [abcdefgABCDEFGkqKQ\-]* [a-z0-9\-]* [0-9]* [0-9]*"`
